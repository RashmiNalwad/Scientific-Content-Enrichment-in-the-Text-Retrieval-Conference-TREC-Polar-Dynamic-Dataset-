...
{
 alert(SUB_DOMAIN);
 var textToSearch=document.getElementById("viewIndexResults").value;
 alert(textToSearch);
 if(textToSearch.length==0)
 alert("Please provide the search city");
 else
 {
 	  var the_url = "http://localhost:8984/solr/HW2/select?q="+textToSearch+"&wt=json&indent=true&callback=myFunction()";
